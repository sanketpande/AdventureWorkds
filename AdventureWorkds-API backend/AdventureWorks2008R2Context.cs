...
{
    public partial class AdventureWorks2008R2Context : DbContext
    {
        public AdventureWorks2008R2Context()
        {
        }

        public AdventureWorks2008R2Context(DbContextOptions<AdventureWorks2008R2Context> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Server=tcp:devdbtest.database.windows.net,1433;Initial Catalog=AdventureWorks2008R2;Persist Security Info=False;User ID=sanket;Password=Pande@123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AwbuildVersion>(entity =>
            {
                ...
                entity.HasComment("Current version number of the AdventureWorks2008R2 sample database. ");
